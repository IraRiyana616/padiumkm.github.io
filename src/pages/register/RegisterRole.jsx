    ...
    <div>
      <div className="relative w-full bg-gray-200">
        <div className="flex flex-col lg:flex-row justify-center items-center lg:min-h-screen ">
          ...
          <div className="max-w-screen-lg w-full bg-white lg:flex mt-10 mb-10 ml-20  h-custom-height">
              ...
              <div className="w-full p-12">
                ...
                <div className="p-3.5 ">
                  <div className="flex flex-col sm:flex-row sm:space-x-5">
                    <div className="flex flex-col border-2 border-gray-300 w-full sm:w-1/2 rounded-lg py-3 px-5 cursor-pointer group transition-all duration-300 hover:border-primary50 hover:bg-blue-100">
                      ...
                      <div className="flex flex-col justify-center space-y-1 mt-7">
                        <div className="font-bold font-nunito text-custom-16 text-center group-hover:text-primary50 transition-colors duration-300">
                          Kebutuhan Bisnis
                        </div>
                        <div className="text-custom-14 font-nunito text-center group-hover:text-tertiary80 transition-colors duration-300">
                    ...
                    <div className="flex flex-col border-2 w-full sm:w-1/2 rounded-lg py-3 px-5 cursor-pointer group transition-all duration-300 hover:border-primary50 hover:bg-blue-100">
                      <div className="flex justify-center items-center">
                        <div className="relative w-10 h-10 mt-3">
                          <img
                ...
                <div className="w-full mb-4 mt-5">
                  <button className="text-custom-14 w-full py-2.5  border-custom-17 rounded-md bg-primary50 flex items-center justify-center transition-colors duration-300">
                ...
                <div className="w-full">
                  <button className="text-custom-14 w-full py-2.5  border-custom-17 rounded-md bg-blue-100 flex items-center justify-center transition-colors duration-300">
          ...
          {/* Row 2 */}
          <div className="relative  h-custom-height bg-gradient-to-r from-[#0193AC] to-[#3EC4DB] w-full hidden lg:flex flex-col justify-center items-center mr-20 p-10">
